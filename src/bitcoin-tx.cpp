...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s iustitiacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  iustitiacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iustitiacoin transaction") + "\n" +
              "  iustitiacoin-tx [options] -create [commands]   " + _("Create hex-encoded iustitiacoin transaction") + "\n" +
              "\n";
