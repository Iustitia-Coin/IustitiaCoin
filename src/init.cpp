...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/iustitiacoin-project/iustitiacoin>";
    const std::string URL_WEBSITE = "<https://iustitiacoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Iustitiacoin version %s\n", FormatFullVersion());
}
